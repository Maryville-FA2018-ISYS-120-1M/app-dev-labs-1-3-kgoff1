...
let double10=Double(10) // let double10: Double = 10
let double3=Double(3) //let double3: Double = 3
let divisionResult=double10/double3
print(divisionResult) // Differs because double allows us to use decimal point accuracy where integer does not
/*:
